...
#create_clock -add -name sys_clk_pin -period 4.00 -waveform {0 2} [get_ports { CLK100MHZ }];
create_clock -add -name sys_clk_pin -period 4.00 -waveform {0 2} [get_ports { CLK100MHZ }];
create_generated_clock -name clkdiv2 -source [get_ports CLK100MHZ] -divide_by 2 [get_pins I_clk_div/CLK_DIV2];
